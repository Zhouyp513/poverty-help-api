 ...
 * @date 2021-10-20
 */
public interface ReliefItemService {
     ...
     * @param addReq 新增Req
     */
    void addItem(ReliefItemAddReq addReq);
     ...
     * @return Pagination
     */
    Pagination<ReliefItemResp> queryByPage(
     ...
     */
    List<ReliefItemResp> queryAllItem();
     ...
     */
    void updateItem(ReliefItemUpdateReq updateReq);
