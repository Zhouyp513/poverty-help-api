...
public interface TraceRecordService {
     ...
     * @param addReq 新增Req
     */
    void addItem(TraceRecordAddReq addReq);
     ...
     * @return Pagination
     */
    Pagination<TraceRecordResp> queryByPage(
     ...
     */
    List<TraceRecordResp> queryAllItem();
     ...
     */
    void updateItem(TraceRecordUpdateReq updateReq);
