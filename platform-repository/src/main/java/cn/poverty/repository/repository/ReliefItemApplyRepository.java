 ...
 * @Description: 扶贫项目申请表Repository
 * @date 2019-08-29
 */
@Mapper
public interface ReliefItemApplyRepository extends BaseRepository<ReliefItemApply>{
     ...
     */
    @Update("<script>" +
            " UPDATE relief_item_apply item set item.delete_status = #{deleteStatus} " +
            " WHERE item.relief_item_apply_id IN " +
