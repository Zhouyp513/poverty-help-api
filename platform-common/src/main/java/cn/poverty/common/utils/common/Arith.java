...
public class Arith {
     ...
     * @return 两个参数的积
     */
    public static BigDecimal multiply(Integer b1, BigDecimal b2) {
        return BigDecimal.valueOf(Long.valueOf(String.valueOf(b1))).multiply(b2).setScale(2,BigDecimal.ROUND_HALF_UP);
    }
